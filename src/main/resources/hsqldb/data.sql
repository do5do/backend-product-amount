...
VALUES (1, 'COUPON', '30000원 할인쿠폰', 'WON', 30000, '2022-11-01', '2024-03-01', current_timestamp, null);
INSERT INTO promotion(id, promotion_type, name, discount_type, discount_value, use_started_at, use_ended_at, created_at, modified_at)
VALUES (2, 'CODE', '15% 할인코드', 'PERCENT', 15, '2022-11-01', '2024-03-01', current_timestamp, null);
